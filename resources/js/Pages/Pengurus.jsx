...
// Komponen Card yang di-upgrade dengan desain ultra-interaktif
function MemberCard({ title, members, delay = 0, variant = "default" }) {
    // Styling dinamis tingkat lanjut berdasarkan level kepengurusan
    const styles = {
        pembina:
    ...
    // Mode gelap untuk teks di dalam card Pembina
    const isDark = variant === "pembina";
    ...
    return (
        ...
        >
            {/* Efek Cahaya Halus di Latar Belakang Card (muncul saat hover) */}
            ...
            {/* List Nama dalam bentuk modern tags yang interaktif */}
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-24">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
                            ...
                            <MemberCard
                                title="Bendahara"
                                members={["Rossi", "Rizky Januar Afrizal"]}
                                variant="inti"
                                delay={0.5}
                            />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <MemberCard
                                title="PJ Sinoman"
                                members={["Hanung", "Azizah", "Wiwit"]}
                                delay={0.3}
                            />
                            <MemberCard
                                title="PJ Dekorasi"
                                members={["Danan", "Jimmy", "Seluruh Anggota"]}
                                delay={0.4}
                            />
                            <MemberCard
                                title="Informasi"
